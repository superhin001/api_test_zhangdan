...
<body>
    ...
    */
    ...
    <div class='page-header'>
        <h1>api test</h1>
    <p class='attribute'><strong>开始时间:</strong> 2018-10-14 12:12:20</p>
<p class='attribute'><strong>运行时长:</strong> 0:00:00.002000</p>
<p class='attribute'><strong>状态:</strong> 错误 1</p>
    ...
    <tr class='errorClass'>
        <td>card.test_user_login.TestUserLogin</td>
        <td>1</td>
        <td>0</td>
        <td>0</td>
        <td>1</td>
...
<tr id='ft1.1' class='none'>
    <td class='errorCase'><div class='testcase'>test_user_login_normal</div></td>
  ...
  File "E:\Python自动化接口\接口20181014\testcase\card\test_user_login.py", line 18, in test_user_login_normal
    case_data = get_case_data()("test_user_data.xlsx",
TypeError: get_case_data() missing 3 required positional arguments: 'data_file', 'sheet', and 'case_name'
